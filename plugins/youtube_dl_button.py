...
async def youtube_dl_call_back(bot, update):
    ...
    ad_string_to_replace = "ᴛᴏ ʀᴇᴘᴏʀᴛ ᴛʜɪs ɪssᴜᴇ, ᴋɪɴᴅʟʏ ᴠɪsɪᴛ [yt-dl.org/bug](https://yt-dl.org/bug). ᴇɴsᴜʀᴇ ʏᴏᴜ ʜᴀᴠᴇ ᴛʜᴇ ʟᴀᴛᴇsᴛ ᴠᴇʀsɪᴏɴ ʙʏ ᴄʜᴇᴄᴋɪɴɢ [yt-dl.org/update](https://yt-dl.org/update) ғᴏʀ ᴜᴘᴅᴀᴛɪɴɢ ɪɴsᴛʀᴜᴄᴛɪᴏɴs. ᴡʜᴇɴ ʀᴇᴘᴏʀᴛɪɴɢ, ᴘʟᴇᴀsᴇ ᴄᴀʟʟ ʏᴏᴜᴛᴜʙᴇ-ᴅʟ ᴡɪᴛʜ ᴛʜᴇ --ᴠᴇʀʙᴏsᴇ ғʟᴀɢ ᴀɴᴅ ɪɴᴄʟᴜᴅᴇ ᴛʜᴇ ᴄᴏᴍᴘʟᴇᴛᴇ ᴏᴜᴛᴘᴜᴛ."
    ...
    if t_response:
        ...
        try:
            ...
            try:
                ...
                await update.message.edit(text="ғɪʟᴇ ɴᴏᴛ ғᴏᴜɴᴅ 🥲")
        ...
        text="ᴇʀʀᴏʀ : ғɪʟᴇ ɴᴏᴛ ғᴏᴜɴᴅ ☹️", message_id=update.message.message_id)
