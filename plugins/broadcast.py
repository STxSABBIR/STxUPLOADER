...
async def broadcast_(c, m):
    ...
    out = await m.reply_text(
        text = f"ʙʀᴏᴀᴅᴄᴀsᴛ ᴜɴᴅᴇʀᴡᴀʏ! ᴇxᴘᴇᴄᴛ ᴀ ʟᴏɢ ғɪʟᴇ ɴᴏᴛɪғɪᴄᴀᴛɪᴏɴ ᴏɴᴄᴇ ᴀʟʟ ᴜsᴇʀs ʜᴀᴠᴇ ʙᴇᴇɴ ɪɴғᴏʀᴍᴇᴅ."
    )
    ...
    if failed == 0:
        await m.reply_text(
            text=f"ʙʀᴏᴀᴅᴄᴀsᴛ sᴜᴄᴄᴇssғᴜʟʟʏ ᴄᴏᴍᴘʟᴇᴛᴇᴅ ɪɴ `{completed_in}`.\n\nᴛᴏᴛᴀʟ ᴜsᴇʀs: {total_users}\nᴛᴏᴛᴀʟ ᴄᴏᴍᴘʟᴇᴛᴇᴅ: {done} ({success} sᴜᴄᴄᴇssғᴜʟ, {failed} ғᴀɪʟᴇᴅ).",
            quote=True
        )
    else:
        await m.reply_document(
            document='broadcast.txt',
            caption=f"ʙʀᴏᴀᴅᴄᴀsᴛ ʜᴀs ʙᴇᴇɴ sᴜᴄᴄᴇssғᴜʟʟʏ ᴄᴏɴᴄʟᴜᴅᴇᴅ ᴡɪᴛʜɪɴ `{completed_in}`.\n\nᴛᴏᴛᴀʟ ᴜsᴇʀs ʀᴇᴀᴄʜᴇᴅ: {total_users}\nᴛᴏᴛᴀʟ ᴄᴏᴍᴘʟᴇᴛᴇᴅ: {done} ({success} sᴜᴄᴄᴇssғᴜʟ, {failed} ғᴀɪʟᴇᴅ).",
            quote=True
        )
